...
#         num_simulations=config.NUM_SIMULATIONS["train"],
...
#         output_dir=config.SIMULATED_DIR,
#         num_simulations=config.NUM_SIMULATIONS["val"],
#         env_target="forest",
#         dataset_type="val"
#     )
...
#         noise_dir=config.NOISE_VALTEST_DIR,
#         output_dir=config.SIMULATED_DIR,
#         num_simulations=config.NUM_SIMULATIONS["test"],
#         env_target="forest",
#         dataset_type="test"
#     )
...
# Training
print("\nTraining the model...")
train_model(model, optimizer, criterion, train_csv, val_csv, simulation_dir, device, label_map, epochs=10, batch_size=32, regenerate_every=10)
