...
# print("\nGenerating Only Outdoor Noise Test Dataset...")
...
test_noise = os.path.join(config.METADATA_DIR, "simulation_metadata_forest_noiseonly_test.csv")
test_csv = merge_metadata([test_in, test_out,test_noise], os.path.join(config.METADATA_DIR, "simulation_metadata_forest_all_test.csv"))
